			...
			<nav class="lnbNav">
				...
				<div id="snb" class="lnb">
					...
					<ul id="lnb" class="lnb_dep1">
						...
						<li id="08-02"><a href="/counsel.do?method=faq"
							class="menuLnb"><span>자주 묻는 질문</span></a></li>
						<li id="08-03" class="active"><a
							href="/counsel.do?method=myCounselList" class="menuLnb"><span>1:1상담</span></a>
						</li>
				...
				<div>
					<div class="content_wrap content_1on1_counsel">
						...
						<form id="Frm" name="Frm" method="post">
							<input type="hidden" id="index" name="index" value="${dto.index}">
							<table class="tbl_data tbl_form">
								...
								<thead>
									<tr>
										...
										<td><select id="cat" name="category" title="상담 분류 선택">
								...
								window.addEventListener("load", function () {
									var opt = document.querySelectorAll("#cat option");
									for (var i = 0; i < opt.length; i++) {
										if (opt[i].value == '${dto.category}') {
											$("#cat option:eq("+i+")").attr("selected","selected");	
											break;
										}
									}
								});
									...
									<tr>
										...
										<td><input type="text" id="title" name="title"
											maxlength="100" value="${dto.title }" style="width: 100%"
											title="제목 입력"></td>
									</tr>
									<tr>
										<th scope="row"><span>내용</span><span class="req">*<span>필수입력</span></span></th>
										<td><textarea title="내용 입력" id="content" name="content"
												maxlength="2000" onkeyup="checkMaxSize(2000,'content');"
												style="height: 200px">${dto.content }</textarea>
											<p class="comt_valid color_key1">* 내용은 2000자까지 입력이 가능합니다.</p>
											<p class="comt_valid">
												* 1:1상담 게시판 및 고객센터 이용 시 욕설 및 비방, 혐오표현 등이 포함되어 있는 경우 “이용약관
												제7조(서비스의 이용 및 제한) 7조 3항 6”에 따라 사전통지 없이 탈퇴 또는 일정기간 동안 서비스 이용에
												제한을 받을 수 있습니다. <br> 또한 “정보통신망 이용촉진 및 정보보호 등에 관한 법률
												제44조의7(불법정보의 유통금지 등)” 등에 의해 처벌받을 수 있사오니, 이 점 양지하시어 이용
												부탁드립니다.
											</p></td>
									</tr>
									<script>
						...
						<p class="note_result_search bottom">
							<span class="color_key1">*</span>는 필수 입력사항입니다.
						</p>
						<div class="btns_submit search">

							<a id="submit" class="btn_common mid blu"">수정하기</a> <a
								class="btn_common mid" href="list">내 상담목록</a>
						</div>
						<div class="group_content">
							<div class="group_inner">
								<ul class="list_text_common">
									<li>인터넷 서비스에 대한 이용에 대한 문의사항을 등록해 주시면 답변해 드리고 있습니다.</li>
									<li>1:1상담 게시판 및 고객센터 이용 시 욕설 및 비방, 혐오표현 등이 포함되어 있는 경우
										"이용약관 제7조(서비스의 이용 및 제한) 7조 3항 6"에 따라 사전통지 없이 탈퇴 또는 일정기간 동안 서비스
										이용에 제한을 받을 수 있습니다.</li>
									<li>또한 “정보통신망 이용촉진 및 정보보호 등에 관한 법률 제44조의7(불법정보의 유통금지 등)”
										등에 의해 처벌받을 수 있사오니, 이 점 양지하시어 이용 부탁드립니다.</li>
								</ul>
							</div>
						</div>
						<script>
							$(function() {
								$('#submit').click(function() {
									var ans = confirm("해당 내용으로 수정하시겠습니까?");
									if (!ans) {
										return;
									} else {
										$('#Frm').submit();
