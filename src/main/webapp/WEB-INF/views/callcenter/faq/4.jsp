			...
			<nav class="lnbNav">
				<div id="snb" class="lnb">
					...
					<ul id="lnb" class="lnb_dep1">
						...
						<li id="08-02" class="active"><a href="${pageContext.request.contextPath }/callcenter/faq/all" class="menuLnb"><span>자주 묻는 질문</span></a></li>
				...
				<div class="content_wrap">
					...
					<div class="tab_article tab_size6">
						<ul>
							...
							<li class="active"><strong>기타</strong><span class="accessibility">현재 선택됨</span></li>
						</ul>
					</div>
                           ...
                           <ul class="pagination">
                              <c:choose>
                                 <c:when test="${startPageNum ne 1 }">
                                    <li><a href="etc?pageNum=${startPageNum-1 }">&laquo; </a></li>
                                 </c:when>
                                 <c:otherwise>
                              ...
                              <c:forEach var="i" begin="${startPageNum }" end="${endPageNum }" step="1">
                                 <c:choose>
                                    <c:when test="${i eq pageNum }">
                                       <li class="active"><a
                                          href="etc?pageNum=${i }">${i }</a></li>
                                    </c:when>
                                    <c:otherwise>
                                       <li><a href="etc?pageNum=${i }">${i }</a></li>
                                    </c:otherwise>
                                 </c:choose>
                              </c:forEach>
                              ...
                              <c:choose>
                                 <c:when test="${endPageNum lt totalPageCount }">
                                    <li><a href="etc?pageNum=${endPageNum+1 }">&raquo; </a></li>
                                 </c:when>
                                 <c:otherwise>
