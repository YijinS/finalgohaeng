...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/reset.css?ver=1" />
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/purchase.css?ver=1" />
</head>
<body>
<div class="game-645-wrap">
    <div class="game-645-header">
        <div class="current">
            <div class="now">
                <h2><span>제</span><strong id="curRound">873</strong><span>회</span></h2>
                <p><span>남은시간</span><strong id="countTime">6일 08:42</strong></p>
            </div>
            <ul class="prize_and">
        ...
        <div class="past">
            <h3><strong>872</strong>회 당첨결과</h3>
            <p>
                <span class="ball color1"><span>2</span></span><!-- 볼 컬러 1~10 color1, 11~20 color2, 21~30 color3 31~40 color4, 41~45 color5 -->
                <span class="ball color1"><span>4</span></span>
                <span class="ball color3"><span>30</span></span>
                <span class="ball color4"><span>32</span></span>
                <span class="ball color4"><span>33</span></span>
                <span class="ball color5"><span>43</span></span>
                <span class="ext">보너스번호</span>
                <span class="ball color3"><span>29</span></span>
            </p>
        ...
        <div class="select-number">
            <div class="header">
                ...
                <ul id="tabWay2Buy">
               	...
               	<input type="hidden" id="ROUND_DRAW_DATE" name="ROUND_DRAW_DATE" value="2019/08/24">
               	<input type="hidden" id="WAMT_PAY_TLMT_END_DT" name="WAMT_PAY_TLMT_END_DT" value="2020/08/25">
            </div>
            <div class="ways">
                <!-- 번호선택/자동번호발급 -->
                    ...
                    <div class="paper">
                        ...
                        <div id="checkNumGroup" class="check">
                        	...
                        	<c:forEach var="number" begin="1" end="45" step="1">
                        		...
                        		<input type="checkbox" id="check645num${number }" name="check645num" onchange="checkLength645($(this))" value="${number }">
                            	<label for="check645num${number }">${number }</label>
                        	</c:forEach>
        ...
        <div class="selected-games">
            ...
            <div class="footer">
                <div class="set set1">
                    ...
                    <strong><span id="moneyBalance">2,000</span><span>원</span></strong>
                </div>
                <div class="set set2">
                    <span>결제금액</span>
