				...
				<div id="snb" class="lnb">
					...
					<ul id="lnb" class="lnb_dep1">
						<li id="07-01"><a href="${pageContext.request.contextPath }/mypage/home" class="menuLnb"><span>마이페이지
									홈</span></a></li>
						<li id="07-02" class="active"><a href="${pageContext.request.contextPath }/mypage/purchasewinning/1" class="menuLnb"><span>구매/당첨</span></a>
							<ul class="lnb_dep2" style="display: block;">
								<li id="07-02-01" class="active"><a href="${pageContext.request.contextPath }/mypage/purchasewinning/1"><span>
											구매당첨내역</span></a></li>
								<li id="07-02-02"><a href="${pageContext.request.contextPath }/mypage/purchasewinning/2"><span> 미확인복권내역</span></a></li>
								<li id="07-02-03"><a href="${pageContext.request.contextPath }/mypage/purchasewinning/3"><span> 고액당첨내역</span></a></li>
							</ul></li>
