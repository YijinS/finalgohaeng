			...
			<nav class="lnbNav">
				...
				<div id="snb" class="lnb">
					...
					<ul id="lnb" class="lnb_dep1">
						...
						<li id="03-07" class="active"><a href="${pageContext.request.contextPath }/gameresult/winningnews/1" class="menuLnb"><span>당첨소식</span></a>
							<ul class="lnb_dep2" style="display: block;">
								...
								<li id="03-07-02" class="active"><a href="${pageContext.request.contextPath }/gameresult/winningnews/2"><span> 당첨 소감 게시판</span></a></li>
							</ul></li>
