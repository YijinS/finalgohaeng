			...
			<section class="contentSection">
						...
						<ul id="lnb" class="lnb_dep1">
							...
							<li id="03-08" class="active"><a href="${pageContext.request.contextPath }/gameresult/unreceived/1" class="menuLnb"><span>미수령
								...
								<ul class="lnb_dep2" style="display: block;">
									<li id="03-08-01" class="active"><a href="${pageContext.request.contextPath }/gameresult/unreceived/1"><span> 로또6/45</span></a></li>
				...
				<div id="article" class="contentsArticle">
					<div class="header_article">
						<h3 class="sub_title">로또6/45</h3>
						<p class="location">
							<a class="home" href="/"> Home </a><span class="gt">&gt;</span><a
								href="/gameResult.do?method=byWin">당첨결과</a><span class="gt">&gt;</span><a
								href="/gameResult.do?method=notReceiveInfo"><span>미수령
									당첨금</span></a><span class="gt">&gt;</span><a
								href="/gameResult.do?method=notReceiveInfo"> 로또6/45</a>
						</p>
					</div>
					<div>
						<div class="content_wrap content_result_notreceive_645">
							<!-- -------------------------------------------------------------------------------------- -->
							...
							<div class="group_content">
								<div class="group_title">
									<h4 class="title">만기도래 2개월 이내 고액(1,2등) 미수령 당첨금 현황</h4>
									<p class="note_req">[2019-07-20 기준]</p>
								</div>
								<table class="tbl_data tbl_data_col">

									<caption>추첨일, 지급기한 만료일, 회차, 등위, 미수령 당첨금, 해당회차 당첨번호,
										당첨지역 등 로또 6/45 미수령 당첨금 안내</caption>
									<colgroup>
										<col width="110px">
										<col width="130px">
										<col width="65px">
									...
									<thead>
										<tr>
											<th scope="col">추첨일</th>
											<th scope="col">지급기한 만료일</th>
											<th scope="col">회차</th>
											<th scope="col">등위</th>
											<th scope="col">미수령 당첨금</th>
											<th scope="col">해당회차 당첨번호</th>
											<th scope="col">당첨지역</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											...
											<td>2019-07-29</td>
											<td>817</td>
											<td colspan="4">해당 회차의 1,2등 미수령 당첨금은 없습니다.</td>
										</tr>
										<tr>
											<td>2018-08-04</td>
											<td>2019-08-05</td>
										...
										<tr>
											...
											<td>824</td>
											<td>1</td>
											<td>1,256,646,550원</td>
											<td>7, 9, 24, 29, 34, 38</td>
											<td>경기</td>
										</tr>
										<tr>
											<td>2018-09-15</td>
							...
							<div class="btns_submit" id="view_all" style="display: block">
								<a class="btn_common mid toggle_open"
									href="javascript:all_view(1)"><span>만기도래 2개월 이내 전체
										미수령 당첨금 현황 보기</span></a>
							</div>
							<div class="group_content" id="not_receive_all"
								style="display: none">
								<div class="group_title">
									<h4 class="title">만기도래 2개월 이내 전체 미수령 당첨금 현황</h4>
									<p class="note_req">[2019-07-20 기준, 백만원 단위]</p>
								</div>
								<table class="tbl_data tbl_data_col">
									<caption>추첨일, 회차, 각 등위 별 미수령 당첨금, 미수령 당첨자수 기준 미수령 당첨금
										현황 안내</caption>
									<colgroup>
										<col width="65px">
										<col width="130px">
									...
									<thead>
										<tr>
											<th scope="row" colspan="2">추첨일</th>

											<th scope="col">18.07.28</th>

											<th scope="col">18.08.04</th>

											<th scope="col">18.08.11</th>

											<th scope="col">18.08.18</th>

											<th scope="col">18.08.25</th>

											<th scope="col">18.09.01</th>

											<th scope="col">18.09.08</th>

											<th scope="col">18.09.15</th>

										</tr>
										<tr>
											<th scope="row" colspan="2">회차</th>
									...
									<tbody>
										<tr>
											<th scope="row" rowspan="2">1등</th>
											<th scope="row">미수령 당첨금</th>
										...
										<tr>
											<th scope="row" colspan="2">회차별 미수령 당첨금</th>
								...
								<div class="btns_submit">
									<a class="btn_common mid toggle_close"
										href="javascript:all_view(2)"><span>만기도래 2개월 이내 전체
											미수령 당첨금 현황 닫기</span></a>
								</div>
							</div>
						</div>
					</div>
