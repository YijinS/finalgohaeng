			...
			<nav class="lnbNav">
				<div id="snb" class="lnb">
					...
					<ul id="lnb" class="lnb_dep1">
						...
						<li id="03-02" class="active"><a href="${pageContext.request.contextPath }/gameresult/pension520/1" class="menuLnb"><span>연금복권520</span></a>
							<ul class="lnb_dep2">
								<li id="03-02-01" class="active"><a href="${pageContext.request.contextPath }/gameresult/pension520/1"><span>회차별 당첨번호</span></a></li>
