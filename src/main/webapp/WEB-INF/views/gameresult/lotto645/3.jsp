...
<div class="body">
	<div class="containerWrap">
		<section class="contentSection">
			...
			<div>
				<div class="content_wrap content_result_winlist_645">
					<div class="search_data">
						<div class="inner">
							<form name="frm" id="frm" method="post"
								action="/lotto645Confirm.do">
								<input type="hidden" name="nowPage" id="nowPage" value="1">
								<span class="unit label">회차 선택</span> <select id="drwNoStart"
									name="drwNoStart" title="조회 시작 회차 선택">
								...
								</select> <span class="unit">~</span> <select id="drwNoEnd"
									name="drwNoEnd" title="조회 끝 회차 선택">
					...
					<table class="tbl_data tbl_data_col">
						<caption>회차, 당첨번호, 1등 당첨자 수, 1등 당첨금(원), 번호선택방법, 당첨 판매점
							보기 등 로또6/45 회차별 당첨내역 안내</caption>
						<colgroup>
						...
						<thead>
							<tr>
								...
								<th scope="col" rowspan="2">당첨번호</th>
								<th scope="col" rowspan="2">1등 당첨자 수</th>
								<th scope="col" rowspan="2">1등 당첨금(원)</th>
								<th scope="col" colspan="3">번호선택방법</th>
								<th scope="col" rowspan="2">당첨 판매점 보기</th>
							</tr>
							<tr>
								<th scope="col">자동</th>
								<th scope="col">수동</th>
					...
					<div class="btns_function bottom">
						<div class="right">
							<p>조회를 원하는 회차를 선택 후 인쇄하거나 엑셀다운로드가 가능합니다.</p>
							<a class="btn_common form" id="printBtn"
								href="javascript:void(0)" title="새창 열림">인쇄하기</a> <a
								class="btn_common form" id="exelBtn" href="javascript:void(0)">엑셀다운로드</a>
						</div>
					</div>
				</div>
			</div>
