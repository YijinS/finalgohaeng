...
<nav
	...
	<div class="container" id="header-top">
		<a class="navbar-brand" href="#"> <img
			src="${pageContext.request.contextPath }/resources/images/index/logo-header.png"
			width="190px" alt="">
		</a>
	...
	<div class="container" id="header-bot">
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav w-100 justify-content-around">
				<li class="nav-item"><a class="nav-link" href="#">복권구매</a></li>
				<li class="nav-item"><a class="nav-link" href="#">복권정보</a></li>
				<li class="nav-item"><a class="nav-link" href="#">당첨결과</a></li>
				<li class="nav-item"><a class="nav-link" href="#">판매점</a></li>
				<li class="nav-item"><a class="nav-link" href="#">이벤트</a></li>
				<li class="nav-item"><a class="nav-link" href="#">행복공감</a></li>
			</ul>
		</div>
	</div>
</nav>
...
<div class="img-portrait">
	<div class="container py-5">
		<div>
			...
			<div class="col-lg-7" id="main-slide">
				<p>
					<h3>
				...
				<a class="prev_btn"><img src="${pageContext.request.contextPath }/resources/images/index/btn_roll_arrow.png"></a>
				<a class="next_btn"><img src="${pageContext.request.contextPath }/resources/images/index/btn_roll_arrow.png"></a>
