	...
	<div class="containerWrap">
		<section class="contentSection">
					...
					<ul id="lnb" class="lnb_dep1">
						<li id="06-01" class="active"><a href="${pageContext.request.contextPath }/happy/healthy/1" class="menuLnb"><span>건전한
							...
							<ul class="lnb_dep2" style="display: block;">
								...
								<li id="06-01-02" class="active"><a href="${pageContext.request.contextPath }/happy/healthy/2"><span>건전구매 프로그램</span></a></li>
			...
			<div class="header_article">
				<h3 class="sub_title">건전구매 프로그램</h3>
				<p class="location">
					<a class="home" href="/"> Home </a><span class="gt">&gt;</span><a
						href="#">행복공감</a><span class="gt">&gt;</span><a href="#"><span>건전한
							복권문화</span></a><span class="gt">&gt;</span><a href="#">건전구매 프로그램</a>
				</p>
			</div>
			<div>
				<div class="content_wrap content_program_buy">
					...
					<div class="box_visual_top">
						<div class="copy">
							<div class="inner">
								<p>건전한 여가, 행복한 동행</p>
								<p>
									건전한 복권 구매를 위한 동행복권 건전구매 프로그램을 이용하세요. <br>복권은 소액으로 건전하게
									즐기세요.
								</p>
							</div>
						</div>
					...
					<ul class="link_quick">
						<li class="q1"><strong>셀프진단평가</strong><span>자가진단 테스트로
								<br>복권 과몰입 예방하기
						</span><a class="btn_common mid blu" href="#">시작하기</a></li>
						<li class="q2"><strong>셀프 구매계획 설정</strong><span>구매한도
								설정하고 <br>건전한 구매계획 세우기
						</span><a class="btn_common mid blu" href="#">시작하기</a></li>
						<li class="q3"><strong>셀프 휴식계획 설정</strong><span>적당한
								휴식으로 <br>즐겁게 즐기기
						</span><a class="btn_common mid blu" href="#">시작하기</a></li>
					</ul>
