		...
		<div class="content_wrap">
			...
			<ul class="list_faq">
				...
				<li id="seqQa_30" tabindex="" class="">
					...
					<div id="divQuestion30" class="answer" style="display: none;">
						<span class="a">답변</span>
						<div class="answer_content">
							<p>
								<font size="2">동행복권 사이트에서 제공되는 서비스의 원활한 이용을 위해서는 아래 브라우저를
									권장합니다.</font>
							</p>
							<font size="2"></font>
							<p>
							...
							<p>
								<font size="2">• Microsoft Internet Explorer 11 이상<br>•
									Google Chrome 71 이상<br>• Microsoft Edge 47 이상 (Windows 10만
									해당)<br>• Apple Safari 12 이상 (Mac OS만 해당)
								</font>
							</p>
							<font size="2"></font>
							<p>
							...
							<p>
								<font size="2">• 최신 브라우저 다운로드 및 설치 절차 안내<br>1.Microsoft
									...
									&nbsp; &nbsp; &nbsp; &nbsp; Internet Explorer 11이 이미 설치되어 있으므로
									다운로드하여 설치할 필요가 없습니다.<br>&nbsp; &nbsp; (2) Windows 7의경우<br>&nbsp;
									&nbsp; &nbsp; &nbsp; &nbsp; Microsoft Internet Explorer
									Download에서 Windows 7 선택후 다운로드 및 설치 절차에 따라 진행하시면 됩니다.<br>&nbsp;
									&nbsp; &nbsp; &nbsp; (
								</font><a
									href="https://support.microsoft.com/ko-kr/help/17621/internet-explorer-downloads"
									target="_blank"><font size="2">https://support.microsoft.com/ko-kr/help/17621/internet-explorer-downloads</font></a><font
									size="2"> )<br></font>
							</p>
							<p>
								<font size="2"><br></font>
							...
							<p>
								<font size="2">2. Google Chrome<br>&nbsp; - Chrome
									...
									&nbsp; (
								</font><a href="https://www.google.com/chrome/" target="_blank"><font
									size="2">https://www.google.com/chrome/</font></a><font size="2">
									) <br>
								</font>
							</p>
							<p>
							...
							<p>
								<font size="2">4. Apple Safari (Mac OS만 해당)<br>&nbsp;
									...
									target="_blank"><font size="2">https://support.apple.com/ko-kr/HT204416</font></a><font
									size="3"><font size="2"> )</font><br></font>
							</p>
						</div>
					</div>
				</li>

				<li id="seqQa_3" tabindex="">
					<div class="question">
						<div class="inner">
							<span class="q"><span>질문</span></span>
							<p>
				...
				<li id="seqQa_21" tabindex="" class="">
					...
					<div id="divQuestion21" class="answer" style="display: none;">
						<span class="a">답변</span>
						<div class="answer_content">
				...
				<li id="seqQa_26" tabindex="">
					...
					<div id="divQuestion26" class="answer">
						...
						<div class="answer_content">
							<div>■ 로또6/45</div>
							<div>로또6/45의 취소는 원칙적으로 복권이 정상적으로 출력되지 않을 경우에만 가능합니다.</div>
							<div>판매점에서 문제가 발생한 경우, 구매 후 10분 이내(판매시간 마감 전)에 동일한 단말기를 통해
								취소가 가능합니다. 취소 시, 구매금액은 현금으로 환불됩니다.</div>
							<div>인터넷에서 문제가 발생한 경우, 당회차/당일건에 대해서만 관리 담당자를 통해 취소가 가능합니다.
								취소 시, 구매금액은 예치금 계정으로 환불됩니다.</div>
							<div>
								<br>
							</div>
				...
				<li id="seqQa_20" tabindex="">
					...
					<div id="divQuestion20" class="answer">
						...
						<div class="answer_content">
							...
							<div>복권당첨금은 조세특례제한법에 의해 분리과세 됩니다. 당첨금 전액에 대한 과세가 아닌 복권을 구입한
								비용을 제외한 금액에 대해서만 과세를 합니다.</div>
							<div>세율은 3억원까지 기타소득세 20%와 주민세 2%(기타소득세의 10%)를 합한 22%이며, 3억원
								초과는 기타소득세 30%와 주민세 3%를 합한 33%를 원천징수합니다.</div>
							<div>예) 로또6/45 10억원 당첨 시 실수령액</div>
							<div>과세대상금&nbsp; &nbsp; &nbsp; &nbsp; 1,000,000,000원 -
								1,000원(구입비용) = 999,999,000원</div>
							<div>3억원까지&nbsp; 22%&nbsp; 300,000,000 x 0.22 = 66,000,000원</div>
				...
				<li id="seqQa_19" tabindex="">
					...
					<div id="divQuestion19" class="answer">
						...
						<div class="answer_content">
							<div>■ 로또6/45</div>
							<div>1등은 당첨복권 실물과 신분증을 지참하시고 농협은행 본점을 방문하시면 됩니다. (인터넷으로 구매한
								경우도 동일하며, 홈페이지 접속 후 마이페이지에서 티켓정보를 확인할 수 있습니다.)</div>
							<div>2~3등은 당첨복권 실물과 신분증을 지참하시고 농협은행 각 지점을 방문하시면 됩니다. (인터넷으로
							...
							<div>1억원 이상은 ㈜동행복권 콜센터(1588-6450)로 당첨여부 확인 후 방문일자와 방문시간을
								결정한 뒤, 당첨복권 실물과 신분증을 가지고 ㈜동행복권 본사로 방문하시면 됩니다. 당첨 확인 후 지정된 농협은행에서
								당첨금을 지급받을 수 있습니다. (단, 연금복권 1등은 ㈜동행복권에서 지급합니다.)</div>
							<div>1억원 미만~5만원 초과는 당첨복권 실물과 신분증을 가지고 농협은행 각 지점을 방문하시면 됩니다.</div>
							...
							<div>예치금 계정의 금액 출금 시, 마이페이지에서 출금신청을 하시면 요청한 본인 명의 은행 계좌로 이체
								해 드립니다.</div>
						</div>
					</div>
				</li>

				<li id="seqQa_22" tabindex="">
					<div class="question">
						<div class="inner">
							<span class="q"><span>질문</span></span>
							<p>
					...
					<div id="divQuestion2" class="answer">
						...
						<div class="answer_content">
							...
							<p>
								...
								홈페이지(https://www.dhlottery.co.kr)에 가입하시고, 마이페이지/개인정보변경/정보수신여부 및
								관심항목 설정/판매인모집 SMS수신 여부에서“예”로 설정하셔야 하며, 신규판매인 모집공고 문자 발송시
								1588-6450번으로 발송하기 때문에 귀하의 핸드폰에 1588 번호가 스팸으로 설정되어 있지 않도록 유의하시기
								바랍니다.<br>
								<br>
							</p>
							<p>온라인복권 신규판매인 모집은 「복권 및 복권기금법」 제30조 및 동법시행령 제21조 규정에 해당하는
								사람(장애인, 기초생활수급자, 한부모가족 세대주, 독립유공자·국가유공자와 그 유족 또는 가족, 5.18민주유공자와
								그 유족 또는 가족, 고엽제 후유의증 등 환자 및 고엽제 후유증 2세 환자, 참전유공자, 특수임무 유공자와 그 유족
								또는 가족, 보훈보상대상자와 그 유족 등)이 온라인복권을 판매하려는 경우에는 복권사업자는 우선적으로 계약을
								체결하도록 노력하여야 한다는 규정을 따르고 있습니다.</p>
							<p>
								<br>
							</p>
							<p>
								<font color="#ff0000">&nbsp;※&nbsp; 다만, 정부 정책에 따라 모집 대상자는
									변경될 수 있습니다.&nbsp;</font><br>
								<br>
							</p>
							<p>
							...
							<p>
								...
								관한 법률」 제6조에 따라 등록 결정된 국가유공자와 그 유족 또는 가족<br>→ 독립유공자(유족)확인원을
								발급받을 수 있는 독립유공자와 그 유족 또는 가족<br>「국가유공자 등 예우 및 지원에 관한 법률」
								제6조에 따라 등록/결정된 국가유공자와 그 유족 또는 가족<br>→ 국자유공자(유족)확인원을 발급받을 수
								있는 국가유공자와 그 유족 또는 가족<br>
								<br>
							</p>
							<p>
								&lt;복권 및 복권기금법 시행령 제21조&gt;<br>「5/18 민주유공자예우에 관한 법률」 제7조에
								따라 결정 등록된 5/18 민주유공자와 그 유족 또는 가족<br>→ 5/18민주유공자(유족)확인원을
								발급받을 수 있는 5/18민주유공자와 그 유족 또는 가족<br>「고엽제후유의증 등 환자지원 및 단체설립에
								관한 법률」 제4조에 따라 결정/등록된 고엽제후유의증환자 및 고엽제후유증 2세환자<br>→
								고엽제법적적용대상확인원을 발급받을 수 있는 환자<br>「참전유공자예우 및 단체설립에 관한 법률」 제5조에
								따라 결정/등록된 참전유공자<br>→ 국가유공자확인원을 발급받을 수 있는 참전유공자<br>「특수임무유공자
				...
				<li id="seqQa_15" tabindex="">
					...
					<div id="divQuestion15" class="answer">
						<span class="a">답변</span>
						<div class="answer_content">안드로이드는 '크롬', 아이폰은 '사파리'를 권장합니다.
						</div>
					</div>
				</li>
