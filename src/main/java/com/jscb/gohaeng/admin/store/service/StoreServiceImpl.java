...
//		로또 또는 연금 뽑기 
	...
	public void getList(HttpServletRequest request) {
		 ...
		 * //라디오 & 페이징
		 * 
		 * String open_close = request.getParameter("open&close"); String radio_select =
		 * request.getParameter("radio_select");
		 *//*
			 * if(open_close != null) { dto.setRadio_select(open_close); }
	...
	public StoreDto makePagenation(HttpServletRequest request, StoreDto dto) {
